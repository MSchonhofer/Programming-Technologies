...
namespace Logic
{
    public class Library
    {
        ...
        public IBook RentBook(string author, string title, Reader reader)
        {
        ...
        public void ReturnBook(IBook book, Reader reader)
        {
        ...
        public void AddBook(string author, string title)
        {
            ...
            if (catalog != null)
            {
                IBook book = new Book(catalog, dataRepository.ValidBookID);
                dataRepository.AddBook(book);
                dataRepository.AddAction(new AddBook(DateTime.Now, book));
            }
        }
        ...
        public IEnumerable<IAction> GetActionsForBook(IBook book)
        {
