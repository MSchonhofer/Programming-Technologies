...
namespace Tests
{
    ...
    public class TestFillStatic : IFill
    {
        public override void Fill(IDataRepository dataRepository)
        {
            ...
            dataRepository.AddCatalogAsync(c1);
            ...
            dataRepository.AddCatalogAsync(c2);
